...
Gaussian, Gamma, Tweedie, Predictive Modeling
\end{IEEEkeywords}
...
This study utilizes a dataset on superconducting materials, sourced from reference [1]. The dataset contains information about the chemical composition and critical temperature ($T_c$) for various materials. \\
